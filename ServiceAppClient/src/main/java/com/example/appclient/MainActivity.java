...
import com.example.appservice.IAidlServiceInterface;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //使用lifecycle来感知生命周期，当执行对应的生命周期时候，回去执行对应的方法
        ...
        findViewById(R.id.btnStartActivity).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.e(TAG, "onClick: Pid: "+ Process.myPid()+" Tid: "+Thread.currentThread().getId());
