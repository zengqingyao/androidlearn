...
public class UserProvide extends ContentProvider {
    ...
    private static final String TAG = "UserProvide";

    static {
        // 申请的时候为 Uri.parse("content://com.zengqy.contentprovider/user")
        // path 通常为表的名字
        sURIMatcher.addURI("com.zengqy.contentprovider", "user",MATCH_CODE );
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        if(result == MATCH_CODE){
            ...
            Uri resultUri = Uri.parse("content://com.zengqy.contentprovider/user/"+id);
